...
public class DiffuseSmartMaterial extends AAdvancedMaterial {
	...
	public DiffuseSmartMaterial() {
		this(false);
	}

	public DiffuseSmartMaterial(String vertexShader, String fragmentShader, boolean isAnimated) {
		super(vertexShader, fragmentShader, isAnimated);
	}

	public DiffuseSmartMaterial(boolean isAnimated) {
		this(mVShader, mFShader, isAnimated);
	}

	public DiffuseSmartMaterial(int parameters) {
		super(mVShader, mFShader, parameters);
	}

	public DiffuseSmartMaterial(String vertexShader, String fragmentShader) {
