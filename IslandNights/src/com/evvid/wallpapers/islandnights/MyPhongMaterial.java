...
public class MyPhongMaterial extends AAdvancedMaterial {
	...
	protected static final String mFShader = 
	    ...
	    "	vec4 ambient  = uAmbientIntensity * diffuse;\n" + 
	...
	public MyPhongMaterial() {
		this(false);
	}
	
	public MyPhongMaterial(boolean isAnimated) {
		this(mVShader, mFShader, isAnimated);
	}
	
	public MyPhongMaterial(String vertexShader, String fragmentShader, boolean isAnimated) {
		super(vertexShader, fragmentShader, isAnimated);
		mSpecularColor = new float[] { 1.0f, 1.0f, 1.0f, 1.0f };
		mShininess = 96.0f;//
	}
	
	public MyPhongMaterial(float[] specularColor, float[] ambientColor, float shininess) {
		this();
